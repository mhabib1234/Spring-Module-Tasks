package com.academy.Bjit.controller;
...
import com.academy.Bjit.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public ResponseEntity<List<Employee>> getAllEmployees() {
		...
		employeeRepository.findAll().forEach(emp -> empList.add((Employee) emp));
